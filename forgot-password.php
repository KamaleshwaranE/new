...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>OSLMS | Password Recovery</title>
...
.succWrap{
    ...
    <body>
        ...
        <div class="mn-content fixed-sidebar">
                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">      
                            <span class="chapter-title">OSLMS | Online Staff Leave Management System</span>
                        </div>
          ...
          <div class="footer">
                    <p class="copyright"><a href="http://phpgurukul.com/">OSLMS </a>©</p>
