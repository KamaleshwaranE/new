...
<html lang="en">
    ...
    <body>
        ...
        <div class="mn-content fixed-sidebar">
                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">      
                            <span class="chapter-title">OSLMS | Online Staf Leave Management System</span>
                        </div>
          ...
          <div class="footer">
                    <p class="copyright"><a href="https://kamaleshwarane.github.io/cv/">OSLMS </a>©</p>
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h4>Welcome to Online Staff Leave Management System</h4></div>
